...
4. Tell me the detected oracle command for /loop, and offer: /audit-swarm for a baseline health check, and /bridge if I also use other agent CLIs on this repo.
